...
e1 = Event.create({creator_id: user6.id, group_id: group1.id, title: "Water Polo!", description: "Monday, at 1pm, meet everyone at the pool!", location: "Central Park Reservoir!" })
e2 = Event.create({creator_id: group2.creator_id, group_id: group2.id, title: "3v3 Tournament", description: "Monday, at 1pm, meet everyone at the gym!", location: "Courts" })
e3 = Event.create({creator_id: group3.creator_id, group_id: group3.id, title: "Pickup Flag Football!", description: "Monday, at 1pm, dividing up into teams of 7", location: "Great Lawn" })
e4 = Event.create({creator_id: group4.creator_id, group_id: group4.id, title: "Pickup Flag Football!", description: "Monday, at 1pm, dividing up into teams of 7", location: "Great Lawn" })
e5 = Event.create({creator_id: group5.creator_id, group_id: group5.id, title: "Pickup Flag Football!", description: "Monday, at 1pm, dividing up into teams of 7", location: "Great Lawn" })
e6 = Event.create({creator_id: group6.creator_id, group_id: group5.id, title: "Pickup Flag Football!", description: "Monday, at 1pm, dividing up into teams of 7", location: "Great Lawn" })
e7 = Event.create({creator_id: group1.creator_id, group_id: group1.id, title: "Water Polo!", description: "Monday, at 1pm, meet everyone at the pool!", location: "Central Park Reservoir!" })
e8 = Event.create({creator_id: group2.creator_id, group_id: group2.id, title: "3v3 Tournament", description: "Monday, at 1pm, meet everyone at the gym!", location: "Courts" })
e9 = Event.create({creator_id: group3.creator_id, group_id: group3.id, title: "Pickup Flag Football!", description: "Monday, at 1pm, dividing up into teams of 7", location: "Great Lawn" })
e10 = Event.create({creator_id: group4.creator_id, group_id: group4.id, title: "Pickup Flag Football!", description: "Monday, at 1pm, dividing up into teams of 7", location: "Great Lawn" })
e11 = Event.create({creator_id: group5.creator_id, group_id: group5.id, title: "Pickup Flag Football!", description: "Monday, at 1pm, dividing up into teams of 7", location: "Great Lawn" })
e12 = Event.create({creator_id: group6.creator_id, group_id: group6.id, title: "Pickup Flag Football!", description: "Monday, at 1pm, dividing up into teams of 7", location: "Great Lawn" })
